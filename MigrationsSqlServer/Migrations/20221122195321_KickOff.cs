        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Cities_Provinces_ProvienceId",
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    RayonId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Name = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    DateCreated = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Enabled = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Categories_Rayon_RayonId",
                        column: x => x.RayonId,
            ...
            migrationBuilder.InsertData(
                table: "Cities",
                columns: new[] { "Id", "Name", "ProvienceId" },
                values: new object[] { 1, "Seyahan", 1 });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Cities_Name_ProvienceId",
                table: "Cities",
                columns: new[] { "Name", "ProvienceId" },
                unique: true);
